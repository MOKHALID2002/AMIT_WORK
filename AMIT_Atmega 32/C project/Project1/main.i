...
_Bool 
# 22 "Headers.h"
    SDB_AddEntry(uint8,uint8,uint8*,uint8*);
      ...
      case 1:
          ...
          for(Addc=0;Addc<2;Addc++){
                ...
                if(CheckAdd == 1){
                    ...
                    printf("\nor Enter any value to close the Program : ");
                    scanf("%d",&number);
...
Display:
        ...
        printf("\nif you need to Display another ID enter any value : ");
        scanf("%d",&number);
        if(number==1)goto List;
        else goto Display;
        }
...
_Bool 
# 135 "main.c"
    SDB_AddEntry(uint8 id,uint8 year,uint8*g,uint8*c){
